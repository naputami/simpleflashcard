      ...
      <div className="container mx-auto mt-4 p-4">
        ...
        <section className="p-2 border border-accent rounded-xl mt-4">
          ...
          <ul className="list-disc ml-6">
            ...
            <li>
              Kalau benar, kamu bisa klik tombol "sudah hafal". Kalau salah atau
              kamu tidak tahu sama sekali artinya bisa klik tombol belum hafal.
            </li>
          </ul>
        </section>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-4 gap-4 sm:gap-5 mx-auto justify-items-center mt-16">
          {data.map((item) => (
            <Card
              ...
              is_remembered={item.is_remembered}
              cardId={item._id}
            />
          ))}
        </section>
